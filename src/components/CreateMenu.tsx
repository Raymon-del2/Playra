    ...
    return (
        ...
        >
            <Link
                href="/studio/content"
                onClick={onClose}
                className="flex items-center gap-4 px-4 py-2.5 hover:bg-zinc-200/80 transition-colors group"
            >
            ...
            <Link
                href="/live/go"
                onClick={onClose}
                className="flex items-center gap-4 px-4 py-2.5 hover:bg-zinc-200/80 transition-colors group w-full text-left"
            >
                <div className="w-6 h-6 flex items-center justify-center">
                    <svg className="w-5 h-5 text-zinc-900" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
