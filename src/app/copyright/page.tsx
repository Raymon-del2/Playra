            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-12 text-zinc-500 font-medium leading-relaxed">
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">1. Ownership</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">2. Platform Content</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">3. DMCA Compliance</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">4. User Responsibility</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">5. Fair Use</h2>
