        ...
        <div className="sticky top-0 z-10 bg-white/95 backdrop-blur-sm border-b border-zinc-200">
          <div className="px-4 md:px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-zinc-900">Playlists</h1>
      ...
      <div className="px-4 md:px-6 py-6">
        {playlists.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-bold text-zinc-900 mb-2">No playlists yet</h2>
              ...
              <section key={playlist.id} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-zinc-900">{playlist.name}</h2>
                ...
                {playlist.videos.length === 0 ? (
                  <div className="bg-zinc-200/50 rounded-xl p-6 text-center">
                      ...
                      <div key={video.id} className="group flex-shrink-0 w-64">
                        <div className="relative aspect-video rounded-xl overflow-hidden bg-zinc-200 mb-2">
                          ...
                          <button
                            ...
                            className="absolute top-2 right-2 w-7 h-7 bg-white/60 hover:bg-red-500/80 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all"
                        ...
                        <Link href={`/watch/${video.id}`}>
                          <h3 className="text-sm font-semibold text-zinc-900 line-clamp-2 group-hover:text-green-400 transition-colors leading-snug mb-1">
                            {video.title}
                          </h3>
                        </Link>
                        <Link href={`/channel/${video.channel_id}`}>
                          <p className="text-xs text-zinc-500 hover:text-zinc-900 transition-colors">
                            {video.channel_name}
                          </p>
                        </Link>
