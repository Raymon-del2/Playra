...
export default function ChannelPostsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh] bg-white text-zinc-900">
  ...
  if (!channel) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 bg-white text-zinc-900">
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <div className="relative w-full">
        <div
          className="h-32 sm:h-48 md:h-56 w-full bg-gradient-to-r from-blue-900/60 via-purple-800/50 to-black rounded-b-3xl border-b border-zinc-200"
      ...
      <div className="max-w-[1284px] mx-auto px-4 md:px-6 pt-6 sm:pt-8">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-10">
          <div className="w-[100px] h-[100px] sm:w-[140px] sm:h-[140px] rounded-full overflow-hidden bg-zinc-200 flex-shrink-0 border border-zinc-200 shadow-2xl -mt-12 sm:-mt-16 relative z-10">
            {channel.avatar ? (
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/70 backdrop-blur-sm p-4">
          <div className="bg-zinc-50 border border-zinc-200 rounded-3xl w-full max-w-md shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-200">
              <h3 className="text-lg font-bold text-zinc-900">Create a post</h3>
              <button onClick={() => setShowCreateModal(false)} className="text-zinc-500 hover:text-zinc-900">×</button>
            </div>
            <div className="p-5 space-y-4">
              <p className="text-zinc-500 text-sm">Choose what type of post you want to create:</p>
              <div className="space-y-2">
                <Link
                  href="/create/post"
                  onClick={() => setShowCreateModal(false)}
                  className="flex items-center gap-3 p-3 rounded-xl bg-zinc-100 hover:bg-zinc-200 transition-colors"
                >
                  ...
                  <div>
                    <div className="font-bold text-zinc-900 text-sm">Text post</div>
                ...
                >
                  ...
                  <div>
                    <div className="font-bold text-zinc-900 text-sm">Poll</div>
                ...
                >
                  ...
                  <div>
                    <div className="font-bold text-zinc-900 text-sm">Image post</div>
                ...
                >
                  ...
                  <div>
                    <div className="font-bold text-zinc-900 text-sm">Quiz</div>
