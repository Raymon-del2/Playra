        ...
        <div className="px-4 md:px-6 py-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-zinc-900">Liked Videos</h1>
            ...
            <div className="relative max-w-md w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 bg-zinc-200/50 border border-zinc-300 rounded-xl text-zinc-900 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all"
              />
              {isSearching && (
                <button
                  onClick={clearSearch}
      ...
      <div className="px-4 md:px-6 py-6">
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-bold text-zinc-900 mb-2">No liked videos yet</h2>
