...
export default function StudioDashboard() {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden pb-24 lg:pb-0">
      {/* Top bar */}
      <div className="h-14 border-b border-white/10 flex items-center justify-between px-4 sm:px-6 gap-2 overflow-hidden">
        ...
        <div className="flex items-center gap-1 sm:gap-4 flex-shrink-0">
          ...
          <Link href="/studio" className="flex items-center gap-2 px-3 sm:px-4 py-1.5 bg-white/10 hover:bg-white/15 rounded text-sm font-medium transition-colors whitespace-nowrap">
      ...
      <div className="p-4 sm:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mb-6 sm:mb-8">
          {stats.map((stat, i) => (
            <div key={i} className="bg-[#1a1a1a] rounded-xl p-4 sm:p-6 border border-white/5">
        ...
        <div className="bg-[#1a1a1a] rounded-xl p-4 sm:p-6 border border-white/5">
          ...
          <div className="flex flex-col items-center justify-center py-8 sm:py-12 text-center">
            ...
            <p className="text-zinc-400 mb-4 text-sm sm:text-base">Upload and publish a video to get started</p>
