...
export default function StudioDashboard() {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden pb-24 lg:pb-0">
      {/* Top bar */}
      <div className="h-14 border-b border-zinc-200 flex items-center justify-between px-4 sm:px-6 gap-2 overflow-hidden">
        ...
        <div className="flex items-center gap-1 sm:gap-4 flex-shrink-0">
          ...
          <Link href="/studio" className="flex items-center gap-2 px-3 sm:px-4 py-1.5 bg-zinc-200/80 hover:bg-white/15 rounded text-sm font-medium transition-colors whitespace-nowrap">
      ...
      <div className="p-4 sm:p-8">
        <h1 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">Channel dashboard</h1>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mb-6 sm:mb-8">
          {stats.map((stat, i) => (
            <div key={i} className="bg-[#1a1a1a] rounded-xl p-4 sm:p-6 border border-zinc-200">
              <p className="text-xs sm:text-sm text-zinc-500 mb-2">{stat.label}</p>
              <p className="text-2xl sm:text-3xl font-bold">{stat.value}</p>
            </div>
          ))}
        </div>

        <div className="bg-[#1a1a1a] rounded-xl p-4 sm:p-6 border border-zinc-200">
          <h2 className="text-base sm:text-lg font-bold mb-4">Latest video performance</h2>
          <div className="flex flex-col items-center justify-center py-8 sm:py-12 text-center">
            <svg className="w-16 h-16 sm:w-24 sm:h-24 text-zinc-700 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
            </svg>
            <p className="text-zinc-500 mb-4 text-sm sm:text-base">Upload and publish a video to get started</p>
