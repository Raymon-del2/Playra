    ...
    <div className="min-h-screen bg-white text-zinc-900 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="max-w-md w-full text-center">
          {/* Coming Soon Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-200/80 border border-zinc-300 mb-8">
            <svg className="w-4 h-4 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span className="text-zinc-700 text-sm font-medium">Coming Soon</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8 text-left">
            <div className="p-4 rounded-xl bg-zinc-100/50 border border-zinc-200">
              ...
              <p className="text-sm font-medium text-zinc-900">Go Live Anywhere</p>
            ...
            <div className="p-4 rounded-xl bg-zinc-100/50 border border-zinc-200">
              ...
              <p className="text-sm font-medium text-zinc-900">Grow Community</p>
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => router.back()}
              className="inline-flex items-center justify-center w-full px-6 py-3 text-zinc-500 hover:text-zinc-900 transition-colors"
            >
              Go Back
            </button>
          </div>
