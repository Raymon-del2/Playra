            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-12 text-zinc-500 font-medium leading-relaxed">
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">🧪 Be a Beta Tester</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">What You Can Do</h2>
                        
                        <div className="grid gap-4">
                            <div className="bg-zinc-200/80 border border-zinc-200 rounded-xl p-5">
                                <h3 className="text-lg font-bold text-zinc-900 mb-2">📹 Test New Video Features</h3>
                            ...
                            <div className="bg-zinc-200/80 border border-zinc-200 rounded-xl p-5">
                                <h3 className="text-lg font-bold text-zinc-900 mb-2">🎨 Try Beta Studio Tools</h3>
                            ...
                            <div className="bg-zinc-200/80 border border-zinc-200 rounded-xl p-5">
                                <h3 className="text-lg font-bold text-zinc-900 mb-2">🔍 Explore Discovery Experiments</h3>
                            ...
                            <div className="bg-zinc-200/80 border border-zinc-200 rounded-xl p-5">
                                <h3 className="text-lg font-bold text-zinc-900 mb-2">🐛 Report Bugs & Issues</h3>
                                <p className="text-sm">Found something broken? Let us know! Your bug reports help us fix issues before features go live.</p>
                            </div>
                            
                            <div className="bg-zinc-200/80 border border-zinc-200 rounded-xl p-5">
                                <h3 className="text-lg font-bold text-zinc-900 mb-2">💡 Share Your Feedback</h3>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">How to Participate</h2>
                        <ol className="space-y-3 list-decimal list-inside">
                            <li><span className="text-zinc-900">Enable Beta Features</span> - Go to Settings and turn on &quot;Beta Features&quot; in your account preferences</li>
                            <li><span className="text-zinc-900">Join the Beta Channel</span> - Opt-in to receive beta updates and early access notifications</li>
                            <li><span className="text-zinc-900">Test & Report</span> - Use new features and submit feedback through the in-app feedback tool</li>
                            <li><span className="text-zinc-900">Join Discord</span> - Connect with other beta testers and the Playra team on our Discord server</li>
                        </ol>
                    </section>

                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">Current Experiments</h2>
