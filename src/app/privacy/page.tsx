            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-12 text-zinc-500 font-medium leading-relaxed">
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">1. Discovery Data Collection</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">2. Identity Protection</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 italic">3. High-Fidelity Analytics</h2>
